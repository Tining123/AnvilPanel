...
public class AdminPanelAddUserWayGUI {
    ...
    private static void drawPage(Inventory inventory, AdminPanelAddUserWayGUI AdminPanelAddUserWayGUI) {
        ...
        setSign(inventory, com.tining.anvilpanel.gui.AdminPanelAddUserWayGUI.SignEnum.ONLINE, SignMaterialEnum.PLAYER, LangReader.get("选择在线玩家"), new ArrayList<>());
        setSign(inventory, com.tining.anvilpanel.gui.AdminPanelAddUserWayGUI.SignEnum.INPUT, SignMaterialEnum.PAGE, LangReader.get("手动输入"), new ArrayList<>());

...
public class AdminGroupUserDeleteGUI {
    private static final Logger log = Logger.getLogger("Minecraft");
    /**
     * 当前开启的菜单
     */
    private static final Map<UUID, AdminGroupUserDeleteGUI> MENU_OPENING = new ConcurrentHashMap();
     ...
     * @param player
     */
    public AdminGroupUserDeleteGUI(Player player, Group group, String user) {
    ...
    private static void drawPage(Inventory inventory, Player player) {
        ...
        // 设置功能性图标
        PluginUtil.setSign(inventory, AdminGroupUserDeleteGUI.SignEnum.GROUP, SignMaterialEnum.LABEL, user , new ArrayList<>());
        PluginUtil.setSign(inventory, AdminGroupUserDeleteGUI.SignEnum.CONFIRM, SignMaterialEnum.ON, LangReader.get("确认"), new ArrayList<>());
        PluginUtil.setSign(inventory, AdminGroupUserDeleteGUI.SignEnum.CANCEL, SignMaterialEnum.OFF, LangReader.get("取消"), new ArrayList<>());
    }
    ...
    public enum SignEnum implements PublicSignEnumInterface {
        ...
        CONFIRM(41, "确认") {
            ...
            public void deal(Inventory inventory, Player player) {
                ...
                player.sendMessage(LangReader.get("删除成功") + ":" + group.getName() + "->" + user);
            }
        },
        CANCEL(39, "取消") {
            @Override
         ...
         */
        public static AdminGroupUserDeleteGUI.SignEnum findMatchedSign(int checkSlot) {
            for (AdminGroupUserDeleteGUI.SignEnum sign : AdminGroupUserDeleteGUI.SignEnum.values()) {

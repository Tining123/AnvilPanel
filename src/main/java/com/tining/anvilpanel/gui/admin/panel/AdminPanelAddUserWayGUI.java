...
public class AdminPanelAddUserWayGUI {
    private static final Logger log = Logger.getLogger("Minecraft");
    /**
     * 当前开启的菜单
     */
    private static final Map<UUID, AdminPanelAddUserWayGUI> MENU_OPENING = new ConcurrentHashMap();
     ...
     * 收购列表名称
     */
    public static final String GUI_NAME = "管理员选择成员添加方式";
     ...
     * @param player
     */
    public AdminPanelAddUserWayGUI(Player player, Panel panel) {
    ...
    private static void drawPage(Inventory inventory, AdminPanelAddUserWayGUI AdminPanelAddUserWayGUI) {

        setSign(inventory, com.tining.anvilpanel.gui.admin.panel.AdminPanelAddUserWayGUI.SignEnum.ONLINE, SignMaterialEnum.PLAYER, LangReader.get("选择在线玩家"), new ArrayList<>());
        setSign(inventory, com.tining.anvilpanel.gui.admin.panel.AdminPanelAddUserWayGUI.SignEnum.INPUT, SignMaterialEnum.PAGE, LangReader.get("手动输入"), new ArrayList<>());
     ...
     * @param lore
     */
    private static void setSign(Inventory inventory, AdminPanelAddUserWayGUI.SignEnum signEnum, SignMaterialEnum signMaterialEnum
    ...
    public enum SignEnum {
        ...
        ONLINE(21, "在线") {
            ...
            public void deal(Inventory inventory, Player player) {
                ...
                new AdminPanelAddUserChestGUI(player, panel, onlineUser);
            }
        },
        INPUT(23, "手动输入") {
            @Override
            public void deal(Inventory inventory, Player player) {
                ...
                // 一定要注销
                unRegister(player);
                new AdminPanelAddUserAnvilGUI().openGUI(player, panel);
            }
        },
        ;
         ...
         */
        public static AdminPanelAddUserWayGUI.SignEnum findMatchedSign(int checkSlot) {
            for (AdminPanelAddUserWayGUI.SignEnum sign : AdminPanelAddUserWayGUI.SignEnum.values()) {
